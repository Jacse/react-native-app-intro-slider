...
export default class AppIntroSlider extends React.Component {
    ...
    _renderPagination = () => {
        const isLastSlide = this._rtlSafeIndex(this.state.activeIndex) ===  this._rtlSafeIndex(this.props.slides.length - 1);
        const isFirstSlide = this._rtlSafeIndex(this.state.activeIndex) === this._rtlSafeIndex(0);
