...
| onNext           | `function` | `void`                                       | Called when user presses the next button(Not required By default clicking on the Next button user will be navigated to the next slide, You can use this function if you want to trigger another function other than navigating to next slide) |
